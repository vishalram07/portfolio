      ...
      <div className="container contact_container">
        <div className="contact_options">
          <article className='contact_option'>
            ...
            <h4>Email</h4>
            <h5>vishalram676@gmail.com</h5>
            <a href='mailto:vishalram676@gmail.com' target="_blank" rel="noreferrer">Send a message</a>
          </article>
            <article className='contact_option'>
            <FaLinkedin className='contact_option-icon'/>
            <h4>LinkedIn</h4>
            <h5>Vishal Ram V A</h5>
            <a href='https://www.linkedin.com/in/vishal-ram-v-a-16250b25a/' target="_blank" rel="noreferrer">Send a message</a>
          </article>
        </div>
